...
evidence: Fixtures and screenshots pending build.
---

## Intent

Show how an agency analyst would consume search, traffic, and behavior data together.
Surface filters, date ranges, loading, and empty states. Show the source of every
number.
